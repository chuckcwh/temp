...
export const SHOW_MODAL_FEEDBACK = 'SHOW_MODAL_FEEDBACK'
export const HIDE_MODAL_FEEDBACK = 'HIDE_MODAL_FEEDBACK'
...
export function hideFeedbackPopupForm() {
  return {
    type: HIDE_MODAL_FEEDBACK,
  }
}
