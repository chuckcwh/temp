    ...
    <Container>
      <div className={s.footerList}>
        <div className={s.footerItem}>
          ...
          <a
            href={'https://www.google.com.sg/maps/place/71+Ayer+Rajah+Crescent,+' +
            'Singapore+139951/@1.2967471,103.7844749,17z/data=!3m1!4b1!4m2!3m1!1s' +
            '0x31da1a4fd6a29643:0x1cbb8a56dd8c9ccf!6m1!1e1'}
            className={classNames('btn', s.footerMapsButton)}
            target="_blank"
          >
            <img src={map} alt="Find Location" />
          ...
          <ul className={s.footerNav}>
            <li className={s.footerNavItem}>
              <a
                ...
                href="http://smarteredu.org/smarteredu/institution/smarter-edx/eBeecare/"
              >Learn@eBeeACADEMY</a>
            </li>
          </ul>
