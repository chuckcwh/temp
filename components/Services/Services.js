          ...
          <div className="ServicesNav-wrapper">
            <Container>
              <ul className="ServicesNav">
                ...
                <li className="ServicesNav-item">
                  <a className={classNames('ServicesNav-link', (this.state.filter === 'Home Care') ? 'active' : '')} href="/faq" onClick={this._onClickFilter.bind(this, 'Home Care')}>Home Care<span className="ServicesNav-arrow"><div className="nav-caret"></div></span></a>
                </li>
                <li className="ServicesNav-item">
