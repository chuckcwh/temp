    ...
    return (
      <div>
        <Container>
          ...
          <p>
            This Policy sets out the manner in which eBeeCare Pte. Ltd. ("eBeeCare") collects, uses, manages and protects personal data (as defined below) in
            compliance with the provisions of the Personal Data Protection Act 2012.
          </p>
          <p>
            This policy applies to all individuals (as defined below) who provide eBeeCare with personal data or whose personal data is otherwise collected, used
            and/or disclosed by eBeeCare in connection with and/or for the purpose of its operations.
          </p>
          <p>
            This policy supplements but does not supersede or replace any previous consent which an individual may have provided to eBeeCare, nor does it affects any
            rights that eBeeCare may have at law in connection with the collection, use and/or disclosure of any individual's personal data. Subject to that, eBeeCare
            will not collect any personal data from an individual unless the individual has voluntarily chosen to provide us with it.
          </p>
          <p>
            eBeeCare may from time to time update this policy to ensure it is consistent with its future developments or business purposes or to accommodate future
            changes to applicable legal or regulatory requirements. All updates to this policy will be published at https://ebeecare.sg/privacy and appropriate
            notifications of any material revisions will be issued to the relevant persons. Subject to an individual's rights at law, the prevailing terms of the
            policy from time to time shall apply. By continuing their relationship with eBeeCare after any amendments have been introduced and published, individuals
            shall be deemed to have accepted the policy as amended.
          </p>
          <p>
            For the avoidance of doubt, this policy forms part of the terms and conditions, if any, governing an individual's specific relationship with eBeeCare
            ("Client Terms of Service", "Nurse Terms of Service", "Service Contract") and should be read in conjunction with such terms and conditions. In the event of
            any conflict or inconsistency between the provisions of this policy and terms and conditions, the provisions of the terms and conditions shall prevail to
          ...
          <p>
            <strong>"Data Protection Officer"</strong> means the person designated to be responsible for ensuring that eBeeCare complies with the PDPA;
          </p>
          <p>
            <strong>"DNC Registry"</strong> means the Do-Not-Call registry maintained by the Personal Data Protection Commission, pursuant to the PDPA;
          </p>
          <p>
            <strong>"Event Participants"</strong> means persons (whether or not Users) who participate in or attend events or programmes organised or sponsored by eBeeCare from time to time;
          </p>
          <p>
            <strong> </strong>
          </p>
          <p>
            <strong>"Individuals"</strong> means natural persons, whether living or deceased, and "Individual" means any of them;
          </p>
          <p>
            <strong>"Users"</strong> means any Individual who has successfully registered for an account under the category of Clients or Nurse in eBeeCare from time to time;
          </p>
          <p>
            <strong>"PDPA"</strong> means the Personal Data Protection Act 2012;
          </p>
          <p>
            <strong>"Personal Data"</strong> means data that is capable of identifying a natural person, whether on its own or in conjunction with other data that is accessible to eBeeCare;
          </p>
          <p>
            <strong>"Personnel"</strong> shall include any person engaged under a contract of service or contract for service with eBeeCare, management personnel, permanent or temporary employees, as well as advisors, interns and volunteers engaged by eBeeCare from time to time; and
          </p>
          <p>
            <strong>"Potential Personnel"</strong> shall include any Individual who has submitted an application to be engaged by eBeeCare as Personnel.
          </p>
          <h3>
          ...
          <h4>
            <u>Purposes reasonably related to any of the above purposes</u>
            <u></u>
          </h4>
          <p>
          ...
          <h4>
            <u>Purposes for which specific consent was obtained</u>
            <u></u>
          </h4>
          <p>
          ...
          <p>
            eBeeCare will continue to contact Individuals at the telephone numbers provided to eBeeCare in the limited circumstances allowed under the DNC Registry even if these telephone number are registered with the DNC Registry. Individuals who do not wish to receive such messages may notify eBeeCare’s Data Protection Officer at <a href="mailto:contact@ebeecare.com">contact@ebeecare.com</a>.
          </p>
          <h3>
          ...
          <p>
            eBeeCare shall make reasonable security arrangements to prevent unauthorised access, collection, use, disclosure, copying, modification, disposal or
            similar risks to Personal Data in its possession.
          </p>
          <p>
            If eBeeCare transfers Personal Data outside Singapore, eBeeCare will take reasonable steps to ensure that such Personal Data transferred receives a
            standard of protection comparable to the protection received under the PDPA.
          </p>
          <p>
