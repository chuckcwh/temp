      ...
      <div>
        <Container>
          <div>
            ...
            <p>
              <strong>"Admin Fee"</strong> means the amount that eBeeCare will deduct from the Service Fee collected, for the use of the Platform and/or any other amounts owed to eBeeCare.
            </p>
            <p>
              <strong>"Case"</strong>
              refers to any service request created by Client on the Platform and can be found through the marketplace located at www.ebeecare.com/marketplace (such
            ...
            <p>
              <strong>"Dispute Period" </strong> means the 7 days after the Nurse has rendered Services to the Client based on the Participation Agreement, where Nurse or Client can raise a dispute case to eBeeCare.
            </p>
            <p>
              <strong>"External Parties"</strong> means the companies, agencies, societies and/or associations which eBeeCare is affiliated with, to provide Client services that may or may not be available in eBeeCare. Refer to our list of affiliated parties on our website at www.ebeecare.com/about.
            </p>
            <p>
              <strong>"Full-Time Nurse" </strong> means the Nurse that has an existing employment contract with another employer that requires him/her to produce prior approval before taking up any additional external assignments
              .
            </p>
            <p>
              <strong>"Health Information" </strong> means information or an opinion (whether true or not) pertaining to an individual's physical and mental health or disability (at any time) which can include but are not limited to drug allergies, diagnosis, treatment, investigations, records of preventive measures, nursing records, clinical correspondence, referrals for treatment, demographic information, medical history, tests, laboratory results, or any other health related data that is entered into the Platform by the Patient, Client, Nurse, an authorized caregiver, or any other health care professional.
            </p>
            <p>
              <strong>"Nurse" </strong> ("You") means an approved registered user (under the category of 'Nurse'), contracted under his Agreement who utilizes the Platform to offer nursing Services to Clients.
            </p>
            <p>
              <strong>"Nurse Fee"</strong> means the Service Fee less any applicable deductions (or any other reasonable deductions as determined by eBeeCare in its sole discretion).
            </p>
            <p>
              <strong>"Participation Agreement" </strong> means the contract between eBeeCare, Client and Nurse as contained in Annex A.
            </p>
            <p>
              <strong>"Patient"</strong> means the individual who is under medical, nursing care or treatment and will be receiving Services provided by a Nurse.
            </p>
            <p>
              <strong>"Personal Information"</strong> means information or an opinion (including information or an opinion forming part of the Platform), whether true or not, and whether recorded in a physical form or not, about an individual whose identity is apparent, or can reasonably be ascertained, from the information or opinion.
            </p>
            <p>
              <strong>"Proprietary Rights" </strong> means any and all rights, data entered into the Platform, title, ownership and interest in and to copyrights, mask works, industrial designs, trademarks, service marks, trade names, trade secrets, patents, and any other rights to intellectual property, recognized in any jurisdiction, whether or not perfected.
            </p>
            <p>
              <strong>"Services"</strong> means nursing related services provided by Nurses, such as but not limited to general nursing care, caregiver training, consultations, respiratory care, wound care, digestive care and urinary care.
            </p>
            <p>
              <strong>"Service Fee" </strong> means the fee that Client has to pay to eBeeCare. This Service fee is the agreed amount between the Nurse and Client on the Platform for the performance of agreed Services by the Nurse.
            </p>
            <p>
              <strong>"Singapore Nursing License Certification"</strong> means any reasonable proof that the Nurse has been accredited from Singapore Nursing Board.
            </p>
            <p>
              <strong>"Total Fee" </strong> means the sum of the Service Fee and the Admin Fee.
            </p>
            <p>
              <strong>"Universal Precautions"</strong> means the practice of avoiding contact with Patients' bodily fluids, by means of wearing of nonporous articles such as medical gloves.
            </p>
            <p>
            ...
            <p>
              Nurses who are holding an existing full-time job ("<strong>Full-Time Nurses</strong>") shall obtain relevant approval from their supervisors or employers before their engagement with Clients on eBeeCare.
            </p>
            <p>
              Upon request by the Full-Time Nurses' supervisors or employers ("<strong>Requestors</strong>"), eBeeCare may assist, within commercially reasonable means, in the monitoring of any of the activities of these Full-Time Nurses on the Platform. Nurses may be notified in the event of such requests. Nurse agrees and consents that the information regarding their activities on the Platform may be shared with these Requestors where eBeeCare has determined in its sole discretion to share such information.
            </p>
            <p>
